...
# used by `is_japanese_char()`. reference: https://stackoverflow.com/questions/30069846/how-to-find-out-chinese-or-japanese-character-in-a-string-in-python
...
def main():
    ...
    for req in req_list:
        page = requests.get(BASE_URL + req) 
